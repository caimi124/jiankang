...
export const metadata: Metadata = {
  title: 'Maca Root: Benefits, Dosage, Side Effects & Reviews | HerbScience',
  description: 'Complete guide to Maca Root: scientific evidence, traditional use, dosage recommendations, safety information, and real user reviews. Evidence-based herbal medicine.',
  keywords: [
    'maca-root',
    'maca-root benefits',
  ...
  openGraph: {
    title: 'Maca Root: Complete Evidence-Based Guide',
    description: 'Scientific benefits, safe dosage, and real user experiences with Maca Root',
    images: ['/images/herbs/maca-root.jpg'],
    type: 'article'
  },
  alternates: {
    canonical: 'https://herbscience.shop/herbs/maca-root'
  }
}
...
const structuredData = {
  ...
  '@type': 'MedicalWebPage',
  'name': 'Maca Root Guide',
  'description': 'Complete guide to Maca Root benefits, dosage, and safety',
  'about': {
    '@type': 'Drug',
    'name': 'Maca Root',
    'description': 'Herbal supplement',
    'proprietaryName': 'Maca Root'
  },
  ...
  return (
    <>
      ...
      <HerbDetailTabUI
        ...
        overview={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">What is Maca Root?</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              Maca Root (Lepidium meyenii) is a traditional herbal medicine with a rich history of use in various healing systems. 
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-xl">
              ...
              <p className="text-gray-700">
                Maca Root contains various bioactive compounds that contribute to its therapeutic properties. 
        ...
        benefits={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Maca Root Benefits & Uses</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                <h4 className="font-semibold text-green-900 mb-3">Traditional Uses</h4>
                <p className="text-gray-700">
                  Maca Root has been used traditionally for various health conditions. Modern research is exploring these traditional applications.
                </p>
              </div>
              <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                <h4 className="font-semibold text-blue-900 mb-3">Modern Applications</h4>
                <p className="text-gray-700">
                  Contemporary studies are investigating the potential benefits of Maca Root for modern health concerns.
                </p>
              </div>
            </div>
          </>
          ...
          <>
            ...
            <details className="bg-gray-50 p-6 rounded-xl">
              <summary className="font-semibold text-gray-900 cursor-pointer">
                Q: What is Maca Root used for?
              </summary>
              <p className="mt-4 text-gray-700">
                Maca Root has been traditionally used for various health purposes. Modern research continues to explore its potential applications.
              </p>
            </details>
          </>
        }
