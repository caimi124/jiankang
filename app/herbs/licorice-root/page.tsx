...
export const metadata: Metadata = {
  title: 'Licorice Root: Benefits, Dosage, Side Effects & Reviews | HerbScience',
  description: 'Complete guide to Licorice Root: scientific evidence, traditional use, dosage recommendations, safety information, and real user reviews. Evidence-based herbal medicine.',
  keywords: [
    'licorice-root',
  ...
  openGraph: {
    title: 'Licorice Root: Complete Evidence-Based Guide',
    description: 'Scientific benefits, safe dosage, and real user experiences with Licorice Root',
    images: ['/images/herbs/licorice-root.jpg'],
    type: 'article'
  },
  alternates: {
    canonical: 'https://herbscience.shop/herbs/licorice-root'
  }
}
...
const structuredData = {
  ...
  '@type': 'MedicalWebPage',
  'name': 'Licorice Root Guide',
  'description': 'Complete guide to Licorice Root benefits, dosage, and safety',
  'about': {
    '@type': 'Drug',
    'name': 'Licorice Root',
    'description': 'Herbal supplement',
    'proprietaryName': 'Licorice Root'
  },
  'lastReviewed': new Date().toISOString().split('T')[0]
}

export default function licoricerootPage() {
  return (
    <>
      <Header />
      ...
      <HerbDetailTabUI
        ...
        overview={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">What is Licorice Root?</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              Licorice Root (Glycyrrhiza glabra) is a traditional herbal medicine with a rich history of use in various healing systems. 
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-xl">
              ...
              <p className="text-gray-700">
                Licorice Root contains various bioactive compounds that contribute to its therapeutic properties. 
        ...
        benefits={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Licorice Root Benefits & Uses</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                <h4 className="font-semibold text-green-900 mb-3">Traditional Uses</h4>
                <p className="text-gray-700">
                  Licorice Root has been used traditionally for various health conditions. Modern research is exploring these traditional applications.
                </p>
              </div>
              <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                <h4 className="font-semibold text-blue-900 mb-3">Modern Applications</h4>
                <p className="text-gray-700">
                  Contemporary studies are investigating the potential benefits of Licorice Root for modern health concerns.
                </p>
              </div>
            </div>
          </>
          ...
          <>
            ...
            <details className="bg-gray-50 p-6 rounded-xl">
              <summary className="font-semibold text-gray-900 cursor-pointer">
                Q: What is Licorice Root used for?
              </summary>
              <p className="mt-4 text-gray-700">
                Licorice Root has been traditionally used for various health purposes. Modern research continues to explore its potential applications.
              </p>
            </details>
          </>
        }
