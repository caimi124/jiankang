...
export const metadata: Metadata = {
  title: 'Holy Basil: Benefits, Dosage, Side Effects & Reviews | HerbScience',
  description: 'Complete guide to Holy Basil: scientific evidence, traditional use, dosage recommendations, safety information, and real user reviews. Evidence-based herbal medicine.',
  keywords: [
    'holy-basil',
    'holy-basil benefits',
  ...
  openGraph: {
    title: 'Holy Basil: Complete Evidence-Based Guide',
    description: 'Scientific benefits, safe dosage, and real user experiences with Holy Basil',
    images: ['/images/herbs/holy-basil.jpg'],
    type: 'article'
  },
  alternates: {
    canonical: 'https://herbscience.shop/herbs/holy-basil'
  }
}
...
const structuredData = {
  ...
  'description': 'Complete guide to Holy Basil benefits, dosage, and safety',
  'about': {
    '@type': 'Drug',
    'name': 'Holy Basil',
    'description': 'Herbal supplement',
    'proprietaryName': 'Holy Basil'
  },
  'lastReviewed': new Date().toISOString().split('T')[0]
}

export default function holybasilPage() {
  return (
    <>
      <Header />
      ...
      <HerbDetailTabUI
        ...
        overview={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">What is Holy Basil?</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              Holy Basil (Ocimum tenuiflorum) is a traditional herbal medicine with a rich history of use in various healing systems. 
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-xl">
              ...
              <p className="text-gray-700">
                Holy Basil contains various bioactive compounds that contribute to its therapeutic properties. 
        ...
        benefits={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Holy Basil Benefits & Uses</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                <h4 className="font-semibold text-green-900 mb-3">Traditional Uses</h4>
                <p className="text-gray-700">
                  Holy Basil has been used traditionally for various health conditions. Modern research is exploring these traditional applications.
                </p>
              </div>
              <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                <h4 className="font-semibold text-blue-900 mb-3">Modern Applications</h4>
                <p className="text-gray-700">
                  Contemporary studies are investigating the potential benefits of Holy Basil for modern health concerns.
                </p>
              </div>
            </div>
          </>
          ...
          <>
            ...
            <details className="bg-gray-50 p-6 rounded-xl">
              <summary className="font-semibold text-gray-900 cursor-pointer">
                Q: What is Holy Basil used for?
              </summary>
              <p className="mt-4 text-gray-700">
                Holy Basil has been traditionally used for various health purposes. Modern research continues to explore its potential applications.
              </p>
            </details>
          </>
        }
