...
export const metadata: Metadata = {
  title: 'Chamomile: Benefits, Dosage, Side Effects & Reviews | HerbScience',
  description: 'Complete guide to Chamomile: scientific evidence, traditional use, dosage recommendations, safety information, and real user reviews. Evidence-based herbal medicine.',
  keywords: [
    'chamomile',
    'chamomile benefits',
  ...
  openGraph: {
    title: 'Chamomile: Complete Evidence-Based Guide',
    description: 'Scientific benefits, safe dosage, and real user experiences with Chamomile',
    images: ['/images/herbs/chamomile.jpg'],
    type: 'article'
  },
  alternates: {
    canonical: 'https://herbscience.shop/herbs/chamomile'
  }
}
...
const structuredData = {
  ...
  '@type': 'MedicalWebPage',
  'name': 'Chamomile Guide',
  'description': 'Complete guide to Chamomile benefits, dosage, and safety',
  'about': {
    '@type': 'Drug',
    'name': 'Chamomile',
    'description': 'Herbal supplement',
    'proprietaryName': 'Chamomile'
  },
  ...
  return (
    <>
      ...
      <HerbDetailTabUI
        ...
        overview={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">What is Chamomile?</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              Chamomile (Matricaria chamomilla) is a traditional herbal medicine with a rich history of use in various healing systems. 
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-xl">
              ...
              <p className="text-gray-700">
                Chamomile contains various bioactive compounds that contribute to its therapeutic properties. 
        ...
        benefits={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Chamomile Benefits & Uses</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                <h4 className="font-semibold text-green-900 mb-3">Traditional Uses</h4>
                <p className="text-gray-700">
                  Chamomile has been used traditionally for various health conditions. Modern research is exploring these traditional applications.
                </p>
              </div>
              <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                <h4 className="font-semibold text-blue-900 mb-3">Modern Applications</h4>
                <p className="text-gray-700">
                  Contemporary studies are investigating the potential benefits of Chamomile for modern health concerns.
                </p>
              </div>
            </div>
          </>
          ...
          <>
            ...
            <details className="bg-gray-50 p-6 rounded-xl">
              <summary className="font-semibold text-gray-900 cursor-pointer">
                Q: What is Chamomile used for?
              </summary>
              <p className="mt-4 text-gray-700">
                Chamomile has been traditionally used for various health purposes. Modern research continues to explore its potential applications.
              </p>
            </details>
          </>
        }
