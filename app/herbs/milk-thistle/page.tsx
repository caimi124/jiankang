...
export const metadata: Metadata = {
  title: 'Milk Thistle: Benefits, Dosage, Side Effects & Reviews | HerbScience',
  description: 'Complete guide to Milk Thistle: scientific evidence, traditional use, dosage recommendations, safety information, and real user reviews. Evidence-based herbal medicine.',
  keywords: [
    'milk-thistle',
  ...
  openGraph: {
    title: 'Milk Thistle: Complete Evidence-Based Guide',
    description: 'Scientific benefits, safe dosage, and real user experiences with Milk Thistle',
    images: ['/images/herbs/milk-thistle.jpg'],
    type: 'article'
  },
  alternates: {
    canonical: 'https://herbscience.shop/herbs/milk-thistle'
  }
}
...
const structuredData = {
  ...
  '@type': 'MedicalWebPage',
  'name': 'Milk Thistle Guide',
  'description': 'Complete guide to Milk Thistle benefits, dosage, and safety',
  'about': {
    '@type': 'Drug',
    'name': 'Milk Thistle',
    'description': 'Herbal supplement',
    'proprietaryName': 'Milk Thistle'
  },
  ...
  return (
    <>
      ...
      <HerbDetailTabUI
        ...
        overview={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">What is Milk Thistle?</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              Milk Thistle (Silybum marianum) is a traditional herbal medicine with a rich history of use in various healing systems. 
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-xl">
              ...
              <p className="text-gray-700">
                Milk Thistle contains various bioactive compounds that contribute to its therapeutic properties. 
        ...
        benefits={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Milk Thistle Benefits & Uses</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                <h4 className="font-semibold text-green-900 mb-3">Traditional Uses</h4>
                <p className="text-gray-700">
                  Milk Thistle has been used traditionally for various health conditions. Modern research is exploring these traditional applications.
                </p>
              </div>
              <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                <h4 className="font-semibold text-blue-900 mb-3">Modern Applications</h4>
                <p className="text-gray-700">
                  Contemporary studies are investigating the potential benefits of Milk Thistle for modern health concerns.
                </p>
              </div>
            </div>
          </>
          ...
          <>
            ...
            <details className="bg-gray-50 p-6 rounded-xl">
              ...
              <p className="mt-4 text-gray-700">
                Milk Thistle has been traditionally used for various health purposes. Modern research continues to explore its potential applications.
              </p>
            </details>
          </>
        }
