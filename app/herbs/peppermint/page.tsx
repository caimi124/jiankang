...
export const metadata: Metadata = {
  title: 'Peppermint: Benefits, Dosage, Side Effects & Reviews | HerbScience',
  description: 'Complete guide to Peppermint: scientific evidence, traditional use, dosage recommendations, safety information, and real user reviews. Evidence-based herbal medicine.',
  keywords: [
    'peppermint',
    'peppermint benefits',
  ...
  openGraph: {
    title: 'Peppermint: Complete Evidence-Based Guide',
    description: 'Scientific benefits, safe dosage, and real user experiences with Peppermint',
    images: ['/images/herbs/peppermint.jpg'],
    type: 'article'
  },
  alternates: {
    canonical: 'https://herbscience.shop/herbs/peppermint'
  }
}
...
const structuredData = {
  ...
  '@type': 'MedicalWebPage',
  'name': 'Peppermint Guide',
  'description': 'Complete guide to Peppermint benefits, dosage, and safety',
  'about': {
    '@type': 'Drug',
    'name': 'Peppermint',
    'description': 'Herbal supplement',
    'proprietaryName': 'Peppermint'
  },
  ...
  return (
    <>
      ...
      <HerbDetailTabUI
        ...
        overview={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">What is Peppermint?</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              Peppermint (Mentha piperita) is a traditional herbal medicine with a rich history of use in various healing systems. 
            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-6 rounded-xl">
              ...
              <p className="text-gray-700">
                Peppermint contains various bioactive compounds that contribute to its therapeutic properties. 
        ...
        benefits={
          <>
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Peppermint Benefits & Uses</h2>
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-green-50 p-6 rounded-xl border-l-4 border-green-500">
                <h4 className="font-semibold text-green-900 mb-3">Traditional Uses</h4>
                <p className="text-gray-700">
                  Peppermint has been used traditionally for various health conditions. Modern research is exploring these traditional applications.
                </p>
              </div>
              <div className="bg-blue-50 p-6 rounded-xl border-l-4 border-blue-500">
                <h4 className="font-semibold text-blue-900 mb-3">Modern Applications</h4>
                <p className="text-gray-700">
                  Contemporary studies are investigating the potential benefits of Peppermint for modern health concerns.
                </p>
              </div>
            </div>
          </>
          ...
          <>
            ...
            <details className="bg-gray-50 p-6 rounded-xl">
              <summary className="font-semibold text-gray-900 cursor-pointer">
                Q: What is Peppermint used for?
              </summary>
              <p className="mt-4 text-gray-700">
                Peppermint has been traditionally used for various health purposes. Modern research continues to explore its potential applications.
              </p>
            </details>
          </>
        }
