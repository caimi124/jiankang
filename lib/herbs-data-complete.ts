...
export const HERBS_DATABASE: Herb[] = [
  {
    ...
    "english_name": "Refined Soybean Oil",
  ...
  },
  {
    ...
    "english_name": "Sweet Fennel Seed",
  ...
  },
  {
    ...
    "english_name": "Purple Echinacea Root",
  ...
  },
  {
    ...
    "english_name": "Narrow-leaf Echinacea Root",
...
export const CONSTITUTION_HERB_MAPPING = {
  ...
  },
  {
    ...
    "description": "圣罗勒（Tulsi）是阿育吠陀医学中最神圣的草药之一，被誉为「草药之后」。作为一种强效适应原，它帮助身体应对身体、精神和情绪压力，支持免疫系统、激素平衡和精神清晰度。广泛用于减轻压力、焦虑、调节血糖和保护环境毒素。",
